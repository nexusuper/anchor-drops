...
// --- first-order prepay + blocklist ------------------------------------
import { firstOrderVerdict, isBulkFirstOrder, isPhoneBlocked, FIRST_ORDER_PREPAY_MIN_QTY as MIN } from '../lib/order-guard.js';
...
// blocklist matches across +63 / 09 spellings, ignores junk
