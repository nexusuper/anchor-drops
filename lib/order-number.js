...
// Unanchored twin of ORDER_NUMBER_RE, for pulling an order number out of free
// text (a Messenger message, an m.me ?ref= payload). Kept beside the anchored
// pattern so the two shapes can never drift apart.
export const ORDER_NUMBER_SEARCH_RE = /(ADW|CFW)-[A-Z]+-\d{6}-[A-Z0-9]{1,4}-\d+/i;
