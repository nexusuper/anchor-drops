...
export const PRODUCTS = [
  { id: 'round5_pickup', name: 'Round Refill (Store Pickup)', description: 'Round-type gallon refill. Order online, pick it up at the store.', refill: 25, container: 135, size: '5-Gal', tag: 'Store Pickup', fulfillment: 'pickup' },
  { id: 'round5', name: 'Round Refill (Delivery)', description: 'Round-type gallon refill, delivered to your door.', refill: 30, container: 130, size: '5-Gal', tag: 'Most Popular', fulfillment: 'delivery' },
  ...
  { id: 'slim5', name: 'Slim Refill', description: 'Slim-type gallon refill. Fits most standard dispensers.', refill: 30, container: 150, size: '5-Gal', tag: 'Standard', fulfillment: 'delivery' },
];
...
// Customer-facing label for orders.container_size (stored value stays '5-Gal').
export const sizeLabel = (s) => (s === '5-Gal' ? 'Gallon' : s);
