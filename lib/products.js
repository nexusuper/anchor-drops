...
export const PRODUCTS = [
  { id: 'round5_pickup', name: '5-Gallon Round (Store Pickup)', description: 'Round-type 5-gallon container refill. Order online, pick it up at the store.', refill: 25, container: 155, size: '5-Gal', tag: 'Store Pickup', fulfillment: 'pickup' },
  { id: 'round5', name: '5-Gallon Round (Delivery)', description: 'Round-type 5-gallon container refill, delivered to your door.', refill: 30, container: 150, size: '5-Gal', tag: 'Most Popular', fulfillment: 'delivery' },
