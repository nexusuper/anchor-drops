import { BUSINESS_PHONE_DISPLAY } from './products';
...
const SMS_MESSAGES = {
  ...
  cancelled: (name, id) =>
    `Hi ${name}, your Anchor Drops water order (ID: ${id}) has been cancelled. Please call us at ${BUSINESS_PHONE_DISPLAY} if you have questions.`,
};
...
const MESSENGER_MESSAGES = {
  ...
  cancelled: (name, id) =>
    `❌ Hi ${name}, your Anchor Drops water order (#${id}) has been cancelled.\n\nIf you have questions, please reply to this message or call us at ${BUSINESS_PHONE_DISPLAY}.`,
};
