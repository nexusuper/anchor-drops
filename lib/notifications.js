...
const SMS_MESSAGES = {
  ...
  cancelled: (name, id) =>
    `Hi ${name}, your Anchor Drops water order (ID: ${id}) has been cancelled. Please call us at 0975-855-5055 if you have questions.`,
};
...
const MESSENGER_MESSAGES = {
  ...
  cancelled: (name, id) =>
    `❌ Hi ${name}, your Anchor Drops water order (#${id}) has been cancelled.\n\nIf you have questions, please reply to this message or call us at 0975-855-5055.`,
};
